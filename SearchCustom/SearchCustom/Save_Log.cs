...
namespace Save_Log_CT
{
    public partial class Save_Log : frmSub 
    {
        ...
        public Save_Log()
        {
            ...
            _Local_CMDFX = @"Data Source=CENL.DYNDNS.INFO,1401;Initial Catalog=CMD-FX;User ID=sa;Password=0000";
            _Local_COMSUP = @"Data Source=CENL.DYNDNS.INFO,1401;Initial Catalog=dbBeautyCommSupport;User ID=sa;Password=0000";
